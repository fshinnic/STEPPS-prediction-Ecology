...
colnames(pollen_og_ts)[!grepl("bacon", colnames(pollen_og_ts))]
...
######################################################################################################################################
# user defs
# THIS CODE IS USING THE LAKES FINLEY HAS
...
# FS - Correctly located Wisconsin lakes in coordinate system
...
# FS - plot domain and core locations in Wisconsin, upper michican, and minnesota (Still correct)
par(mfrow=c(1,1))
